...
| Абразивный/зольный износ (версия NHL) | 🟢 Ослаблен | Низкий Fe в масле NTE200 ([[oil_NTE200]]) ✅ |
...
### 8. Масло
Источник: [[oil_brands_NTE200_730E]], [[oil_NTE200]], [[oil_730E]] (период 2024-02 — 2025-12).
- Двигатели NTE200 и 730E работали на **одном масле — Газпромнефть G-Profi MSI Plus 15W-40 (API CI-4)**. ⇒ марка не дифференцирует.
- Износ по Fe на NTE200: **P95 = 6 ppm** (у 730E P95 = 20 ppm) — низкий. Cu/Cr/Al/Pb в норме.
- ⇒ Абразивный/зольный износ как первопричина **не подтверждается** маслом; отказ — термический.
