...
> Всего ~11 машин / ~13 событий (с повторами на #48, #58). Прежняя оценка «30 событий/24+ ед.» ❌ не подтверждается.
...
### 7. Топливо
25+ паспортов; сера 2–10 мг/кг (Е5, в 2,4× ниже порога Cummins 15 ppm). Нарушение: паспорт №246 (декларация ЕАЭС истекла 24.10.2025). **Топливо исключено как причина.**

### 8. Масло (расширенный анализ ДВС)
Источник: [[Масло ДВС — расширенный анализ NTE200 730E]], [[oil_NTE200]], [[oil_730E]]. Свежие своды «21.05» + «2026», **период 2024-01 — 2026-05**, только ДВС, дедуп (NTE200 — 1583 пробы, 730E — 663). Старый файл (до 2025-12) удалён.

**Использованные масла (ДВС):** NTE200 — **Газпромнефть G-Profi MSI Plus 15W-40** (1141) и **TEBOIL Super HPD Plus 15W-40** (429); 730E — те же + Komatsu/Mobil/Лукойл. Все — SAE 15W-40, тип Моторное (класс API CI-4). ⇒ марка/тип **не дифференцирует** парки.

**Технические показатели масла (медиана, ДВС):**

| Показатель | NTE200 | 730E | Норма | Статус |
|---|---|---|---|---|
| TBN (щёлочное), мгКОН | 9,5 | 9,5 | ≥2,5 | ✅ 0% ниже нормы |
| Сажа (ST) | 0,3 | 0,4 | низкая | ✅ |
| Окисление (OXI) | 0,1 | 0,1 | низкое | ✅ |
| V100, cSt | 15,6 | 15,4 | 12,5–16,3 | ✅ (3–5% вне) |
| Вода / топливо | ~0 / ~0 | ~0 / ~0 | <0,1% / <5% | ✅ |
| Fe (износ) P95 | 5 | 16 | износ | низкий |

> [!check] Вывод по маслу
> Масло ДВС — в **отличном состоянии**: высокий TBN (9,5), **низкая сажа (0,3)**, нет окисления/разбавления, износ низкий. **Низкая сажа прямо опровергает версию NHL** про «поздний впрыск → сажа → зольный/абразивный износ клапанов». Отказ — термический; масло не является фактором и не дифференцирует NTE200 vs 730E. Бренды Газпромнефть и TEBOIL работают эквивалентно.
