...
def page_exec_summary(pdf):
    ...
    rect_r = mpatches.FancyBboxPatch((-0.01, -0.03), 1.02, 0.05,
                                      boxstyle="round,pad=0.01",
                                      facecolor='#EDFFF6', edgecolor=ACCENT, linewidth=1.5)
    ax.add_patch(rect_r)
...
def page_failure_table(pdf):
    ...
    for i, row in enumerate(rows):
        ...
        bg = '#FFF0F0' if is_critical else (PANEL if i % 2 == 0 else BG)
...
def page_cylinder_heatmap(pdf):
    ...
    colors_cmap = [PANEL, '#D0F0E0', '#A0D8B8', ACCENT]
...
if __name__ == '__main__':
    ...
    output = '/home/user/NTE200/Анализ_коренных_причин_ГБЦ_QSK50_NTE200_light_p1.pdf'
