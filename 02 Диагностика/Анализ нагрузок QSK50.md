...
Источник: [[_Данные/Весовая/_Индекс|система взвешивания БЕЛАЗ]] (поле `LoadPercentage`).
...
Источник: [[_Данные/ГЕ/_Индекс|события бортовой системы]]. Event 635 = перегрузка.
