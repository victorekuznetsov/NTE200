...
panel(s,0.5,5.0,12.33,1.3,"Все базовые давления (рампа, масло, наддув) в норме → перегрев НЕ связан с механикой топливоподачи/наддува. Источник перегрева — калибровка (TIB, отключённые защиты) и разброс дозирования форсунок, а не давление в системе.",ACC,12.5,"Вывод")
# аналитические топы
