...
txt(s,6.42,1.62,6.3,4.3,"Топливо: 25+ паспортов, сера 2–10 мг/кг (Е5, в 2,4× ниже порога Cummins). Исключено.\n\nМасло ДВС (2024–2026, 1583 пробы NTE200): Газпромнефть G-Profi MSI Plus + TEBOIL Super HPD Plus, оба 15W-40 CI-4. = как на 730E → не дифференцирует.\n\nСостояние масла отличное: TBN 9,5 (норма ≥2,5), САЖА 0,3 (низкая), окисление 0,1, Fe P95=5.\n\nНизкая сажа ОПРОВЕРГАЕТ версию NHL про «сажа/зола → износ клапанов». Отказ ТЕРМИЧЕСКИЙ.",12,False,INK); footer(s)
