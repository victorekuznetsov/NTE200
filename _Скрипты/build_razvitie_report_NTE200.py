...
# 8d Корреляция форсунки ↔ цилиндры ↔ EGT
s=slide(); header(s,"Корреляция: форсунки ↔ цилиндры ↔ EGT (#82)","ФОРСУНКИ · КОРРЕЛЯЦИЯ")
rect(s,0.5,1.4,12.33,1.5,WHITE); rect(s,0.5,1.4,0.12,1.5,RED)
txt(s,0.72,1.5,11.9,1.35,"Два самых горячих цилиндра Ц2 и Ц6 (567 °C, лимит 520) — это форсунки 1R и 3R,\nобе «брак(2)» с ПЕРЕЛИВОМ на P03/P04 → локальное переобогащение → рост EGT → термоудар клапана.",14,True,INK)
rows=[["Показатель","A-банк (L, нечёт.)","B-банк (R, чёт.)"],
["Дефектных форсунок","3 / 8","6 / 8"],
["Средняя EGT (DML #82)","~465 °C","~525 °C (+60)"],
["Самые горячие цил.","—","Ц2=567, Ц6=567"]]
table(s,0.5,3.1,8.6,[0.4,0.3,0.3],rows,fsize=13,rowh=0.55)
rect(s,9.3,3.1,3.5,2.2,WHITE); rect(s,9.3,3.1,0.12,2.2,ORG)
txt(s,9.5,3.2,3.2,2.05,"B-банк: и больше дефектных форсунок, и выше EGT — согласованный паттерн.\n\nОговорки: часть форсунок недоливает; Ц11 — датчик неисправен; 730E не испытаны.",12,False,INK)
txt(s,0.5,5.6,12.3,0.6,"Перелив форсунок — отягчающий фактор поверх калибровки ЭБУ (TIB=200%), усиливающий дисбаланс в горячих цилиндрах.",12,True,RED)
txt(s,0.5,6.35,12.3,0.4,"Карта цилиндров принята Ц(2k−1)=kL, Ц(2k)=kR (ECM144=A / ECM1=B) — требует подтверждения схемой NHL.",10,False,GRY); footer(s)
