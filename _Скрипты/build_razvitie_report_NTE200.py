...
txt(s,6.42,1.62,6.3,4.3,"Топливо: 25+ паспортов, сера 2–10 мг/кг (Е5, в 2,4× ниже порога Cummins). Исключено как причина.\n\nМасло (2024–2025): двигатели NTE200 и 730E — на одном масле Газпромнефть G-Profi MSI Plus 15W-40 (API CI-4). Не дифференцирует.\n\nИзнос Fe на NTE200: P95 = 6 ppm (730E — 20). Низкий → отказ ТЕРМИЧЕСКИЙ, а не абразивный/зольный. Версия NHL про золу ослаблена.",12.5,False,INK); footer(s)
